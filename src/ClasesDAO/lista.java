...
public class lista {
    ...
    public void insertar(String nombre, String direccion, String imagenPortada) {
        nodo nuevo = new nodo(nombre, direccion, imagenPortada);  // Usamos el nuevo constructor
        if (IsEmpety()) {
            first = last = nuevo;
        } else {
            last.siguiente = nuevo;
